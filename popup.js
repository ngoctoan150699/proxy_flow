...
const TRANSLATIONS = {
  vi: {
    ...
    noSelected: "Chưa chọn proxy. Hãy bấm nút ⚡ trên một proxy để áp dụng.",
  ...
  en: {
    ...
    noSelected: "No proxy selected. Click ⚡ on a proxy to apply it.",
  ...
  ru: {
    ...
    noSelected: "Прокси не выбран. Нажмите ⚡ на прокси, чтобы применить.",
  ...
  es: {
    ...
    noSelected: "No hay proxy seleccionado. Haz clic en ⚡ para aplicarlo.",
  ...
  fr: {
    ...
    noSelected: "Aucun proxy choisi. Cliquez sur ⚡ pour appliquer.",
  ...
  ja: {
    ...
    noSelected: "プロキシ未選択。⚡ をクリックして適用します。",
    displayedSuffix: "件表示",
